...
#else
        private static readonly string BannerId = "ca-app-pub-8110178142432057/7162069442"; // 本番(iOS)
#endif
    private static readonly string InterstitialId = "ca-app-pub-8110178142432057/9450155583"; // 本番
#endif
